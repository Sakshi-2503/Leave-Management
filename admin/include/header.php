...
$sql = "SELECT name, dp FROM admin WHERE email = ?";
$stmt = $conn->prepare($sql);
$stmt->bind_param("s", $email);
$stmt->execute();
$result = $stmt->get_result();
$userData = $result->fetch_assoc();
$name = $userData ? ucwords($userData["name"]) : $email;
$dp = $userData && !empty($userData['dp']) ? $userData['dp'] : 'default.png';
$photoPath = "../admin/upload/$dp";
?>
            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                   <br> <br>       
                    ...
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon"></i><span class="nav-text">Manage Employee Leave</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./accept-leave.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Employee Leave Request</span></a></li>
                            <li><a href="./leave-history.php"> <i class="fa fa-tasks menu-icon"></i><span class="nav-text">View Leave History</span></a></li>
                        </ul>
                    </li>
                    <li>
                    <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-address-card-o menu-icon"></i><span class="nav-text">Salary Management</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./salary_management.php"> <i class="icon-plus menu-icon"></i><span class="nav-text">Manage Salaries</span></a></li>
                        </ul>
                    </li>
                     <li>
                        <a href="./admin_attendance.php"  >
                            <i class="icon-home menu-icon"></i><span class="nav-text">Employee Attendance</span>
